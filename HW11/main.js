...
function getKey(event) {
    ...
    var didCollide = hasCollided(square1, square2);
     // only checking if reached canvas border when a key is pressed
    var touchedBoarder = hasTouchedBorder(square1);
...
function hasTouchedBorder(object1) {
    if (object1.y < (canvas.height-590) || object1.y > (canvas.height-22) || object1.x > (canvas.width-22) || object1.x < 0){
