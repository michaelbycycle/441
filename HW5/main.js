...
function createRandomImageArray()
{
    ...
    var actualImagePath = ["images/pic1.jpg", "images/pic2.jpg", "images/pic3.jpg","images/pic4.jpg", "images/pic5.jpg", "images/pic6.jpg","images/pic7.jpg", "images/pic8.jpg", "images/pic9.jpg","images/pic10.jpg"];
    ...
    while(actualImages.length < 10)
    {
        ...
        var randomNumber = Math.floor(Math.random() * actualImagePath.length)
          // create an if statement that says if the total number added is less than 3, then
